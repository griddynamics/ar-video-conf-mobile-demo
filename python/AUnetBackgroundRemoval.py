...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', '--pascal-voc-path',
                        ...
                        help="specify path to the PascalVOC2012 dataset. Used for in-memory training way (DS v2).")
    parser.add_argument('-c', '--coco-portraints-path',
                        required=False, dest='coco_portraits_path',
                        help="specify path to the Portraits dataset. Used for in-memory training way (DS v1-2).")
    ...
    parser.add_argument('-ch', '--cache', action='store_true',
                        ...
                        help="specify if datasets caching is needed. Should accelerate model training if "
                             "amount of memory (RAM) is enoght.")
    ...
    parser.add_argument('--restore', action='store_true',
                        ...
                        help="to continue model training after crash or the end of training on initial number "
                             "of epochs.")
