package com.griddynamics.video.conf.palm.texture.renderer;
...
public class PalmTextureRenderer {
    ...
    private static final String TAG = "PalmTextureRend";
    ...
    public static final FloatBuffer SQUARE_VERTICES1 = ShaderUtil.floatBuffer(new float[]{0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F});
