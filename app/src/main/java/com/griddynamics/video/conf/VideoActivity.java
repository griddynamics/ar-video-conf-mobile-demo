...
import com.griddynamics.video.conf.camera.VideoActivityCameraHelper;
import com.griddynamics.video.conf.camera.VideoRenderer;
...
public class VideoActivity extends AppCompatActivity {
    ...
    private VideoActivityCameraHelper cameraHelper;
    ...
    private ImageSegmentationModelExecutor1 imageSegmentation;
    @Override
    protected void onResume() {
        ...
        imageSegmentation = new ImageSegmentationModelExecutor1(this, true);
...
/*        renderer = new VideoRenderer(surfaceView, imageSegmentation, 1100, 1100);
    ...
    private void startCamera() {
        cameraHelper = new VideoActivityCameraHelper(surfaceView);
